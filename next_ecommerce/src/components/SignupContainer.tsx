...
const SignupContainer = () => {
  ...
  return (
        ...
        <form className='w-full flex items-center justify-center' onSubmit={handleSubmit}>
          ...
          <h2>User Name</h2>
            <input placeholder='Enter username' value={userName} onChange={(e)=>setUserName(e.target.value)} className='rounded-xl border border-gray-100 h-10 px-3'/>
            <h2>Email</h2>
            ...
            <button type='submit' className='bg-green-500 h-10 rounded-xl'>Login</button>
